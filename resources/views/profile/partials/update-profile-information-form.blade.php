<section>
    ...
    <form method="POST" action="{{ route('profile.update') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name', auth()->user()->name) }}" required class="w-full px-4 py-2 border border-red-200 rounded focus:outline-none focus:ring-2 focus:ring-red-400">
        </div>
        <div>
        ...
        <div class="flex flex-col sm:flex-row gap-2 justify-end">
            <button type="submit" class="bg-red-500 hover:bg-red-600 text-white font-bold px-6 py-2 rounded transition">Save</button>
        </div>
    </form>
</section>
