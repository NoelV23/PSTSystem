<form method="POST" action="{{ route('profile.destroy') }}" class="space-y-4">
    ...
    <div>
        <input type="password" name="password" required placeholder="Password" class="w-full px-4 py-2 border border-red-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
    </div>
