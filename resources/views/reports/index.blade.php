    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            <div class="flex items-center mb-4">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-600">Track installation services and completion</p>
                </div>
            </div>
            <ul class="text-sm text-gray-600 space-y-1 mb-4">
                <li>• Installation sales tracking</li>
                <li>• Completion status</li>
                <li>• Products used in installations</li>
                <li>• Installation revenue</li>
            </ul>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            <div class="flex items-center mb-4">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-gray-900">Sales Quotations</h3>
                    <p class="text-sm text-gray-600">Quotation pipeline and conversions</p>
                </div>
            </div>
            <ul class="text-sm text-gray-600 space-y-1 mb-4">
                <li>• Quotations by status</li>
                <li>• Quoted value totals</li>
                <li>• Conversion to sales</li>
                <li>• Date and branch filters</li>
            </ul>
            <a href="{{ route('reports.quotations') }}" class="inline-flex items-center px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white font-medium rounded-lg transition duration-200">
                View Quotations Report
                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg>
            </a>
